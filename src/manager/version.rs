...
/// `"Poetry (version 2.4.0)"`); this returns just the leading
/// `MAJOR.MINOR(.PATCH)` portion (`"26.1"`, `"2.4.0"`) — the patch segment is
/// optional. If no digits are present, the trimmed input is returned.
